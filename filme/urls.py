...
from .views import Homefilmes, Homepage, Detalhesfilme, Pesquisafilme, Paginaperfil, Criarconta, DeletarConta
from django.contrib.auth import views as auth_view
#from authors import views as vw
...
urlpatterns = [
    ...
    path('excluirconta/<int:pk>', DeletarConta.as_view(), name = 'excluirconta'),
]
