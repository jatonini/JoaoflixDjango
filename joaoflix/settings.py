"""
Django settings for joaoflix project.
...
SECRET_KEY = 'django-insecure-s9@30dz^a5yvdilnhg2zp^8(an91w#%#qm12-v&quqj#k$*$we'
...
WSGI_APPLICATION = 'joaoflix.wsgi.application'
